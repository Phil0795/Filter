...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_value.setItemText(4, QCoreApplication.translate("MainWindow", u"Hysteresis interpol.", None))
        self.comboBox_value.setItemText(5, QCoreApplication.translate("MainWindow", u"Boxplot MAE Hysteresis", None))
